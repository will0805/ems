...
<body style="
  ...
  <div class="htmleaf-container" style="min-height:95%">
	<form class="cd-form floating-labels" ACTION="sele_done.php" METHOD="POST" name="selection_table">
	<fieldset>
...
for ($i=2; $i<=10; $i++){
	...
	if ($i==$opt)
	echo "<OPTION SELECTED value=\"add_selection.php?opt=$i\">$opt";
	else
	echo "<OPTION value=\"add_selection.php?opt=$i\">$i";
