...
<body style="
  ...
  <form class="cd-form floating-labels" name="form1" method="post" action="edit_content.php">
	 <fieldset>
...
for ($i=1; $i<=10; $i++){
	...
	if ($i==$opt)
	echo "<OPTION SELECTED value=\"add_document_ed.php?opt=$i\">$opt";
	else
	echo "<OPTION value=\"add_document_ed.php?opt=$i\">$i";
}
?>
						</select>
	 </fieldset>
