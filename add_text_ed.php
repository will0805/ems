...
<body style="
  ...
  <div class="htmleaf-container" style="min-height:95%">
    <form class="cd-form floating-labels" ACTION="text_done_ed.php" method="POST" name="text_table">
		<fieldset>
...
for ($i=1; $i<=10; $i++){
	...
	if ($i==$text)
	echo "<OPTION SELECTED value=\"add_text_ed.php?text=$i\">$text";
	else
	echo "<OPTION value=\"add_text_ed.php?text=$i\">$i";
}
?>
						</select>
					</p>
